          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:flex-1 space-y-8">
              ...
              <Card className="p-6">
                <div className="flex items-end justify-between gap-4">
                  <div>
                    ...
                    <div className="mt-1 text-sm text-[color:var(--muted)]">
                      Selected visuals (replace with your real diagrams anytime).
                    </div>
                  </div>
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-[color:var(--muted-2)]">
                  {images.map((img) => (
              ...
              <Card className="p-7">
                ...
                <div className="mt-5 space-y-4">
                  {[
                    {
                      icon: Workflow,
                      title: "1) CRM-like workflow without replacing the stack",
                      body:
                    ...
                    {
                      icon: Layers,
                      title: "2) Lead nurturing + accountability design",
                      body:
                    ...
                    {
                      icon: Target,
                      title: "3) Campaign utilization, not just campaign execution",
                      body:
                    ...
                    {
                      icon: CheckCircle2,
                      title: "4) Quality control + feedback loops",
                      body:
                    ...
                    {
                      icon: Sparkles,
                      title: "5) New product onboarding + launches",
                      body:
                    ...
                    {
                      icon: Users,
                      title: "6) Cross-team synergy (HR, ops, IT, sales)",
                      body:
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <item.icon className="h-5 w-5 mt-0.5 text-[var(--brand-gold)]" />
                        <div>
              ...
              <Card className="p-7">
                ...
                <p className="mt-3 text-sm text-[color:var(--muted)] leading-relaxed">
                  ...
                  clearer lead flow, stronger accountability, improved utilization
                  of marketing efforts, and a more consistent customer experience -
                  enabling growth to be supported by architecture rather than ad hoc effort.
                </p>
              ...
              <Card className="p-7">
                ...
                <p className="mt-3 text-sm text-[color:var(--muted)] leading-relaxed">
                  ...
                  response, follow-up, quality, handovers, and internal visibility.
                  Aligning marketing, sales, operations, IT, and human capital into a shared system
                  makes growth predictable and repeatable.
                </p>
                <p className="mt-3 text-sm text-[color:var(--muted)] leading-relaxed">
              ...
              <Card className="p-6">
                ...
                <ul className="mt-3 space-y-2 text-sm text-[color:var(--muted)]">
                  <li className="flex gap-2">
                    <Layers className="h-4 w-4 mt-0.5 text-[var(--brand-gold)]" />
                  ...
                  <li className="flex gap-2">
                    <Workflow className="h-4 w-4 mt-0.5 text-[var(--brand-gold)]" />
