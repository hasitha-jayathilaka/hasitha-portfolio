    ...
    <>
      ...
      <div className="min-h-screen bg-[#0F1322] text-[#F5F1E8]">
        ...
        <main className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          {/* ✅ Two-column layout (continuous sidebar) */}
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="w-full lg:flex-1 space-y-8">
                ...
                <Card className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <div className="mt-1 font-medium">Senaka Batagoda</div>
                    ...
                    <div>
                      ...
                      <div className="mt-1 font-medium">Feb – Jun 2020</div>
                      <div className="text-sm text-white/70">
              ...
              {/* ✅ Media moved into left flow + Lightbox */}
              <Card className="p-6">
              ...
              <Card className="p-7">
                ...
                <p className="mt-3 text-sm text-white/75 leading-relaxed">
                  ...
                  still unfamiliar to many local teams. Strong offline
                  popularity did not automatically translate into verified
                  digital identity, platform control, or predictable
                  monetization.
                </p>
              </Card>
                ...
                <div className="mt-5 space-y-4">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    ...
                    <p className="mt-2 text-sm text-white/75">
                      Consolidated presence and enabled official identity signals
                      across platforms (artist verification, channel structure,
                      and discovery alignment).
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    ...
                    <p className="mt-2 text-sm text-white/75">
                      Implemented a structured distribution layer for catalog
                      publishing, royalty tracking, and consistent metadata -
                      supporting global discovery and monetization.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    ...
                    <p className="mt-2 text-sm text-white/75">
                      Consulted on attribution and contributor rights to keep
                      releases aligned with IP expectations - designed to reduce
                      future disputes and platform restrictions.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    ...
                    <p className="mt-2 text-sm text-white/75">
                      Built a consistent graphic system across social media,
                      thumbnails, and release collateral so the brand looked
                      official, recognizable, and platform-native.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    ...
                    <p className="mt-2 text-sm text-white/75">
                      Turned existing materials into a cohesive omnichannel
                      footprint - transforming scattered presence into a
                      consistent digital home for fans.
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <aside className="w-full lg:w-[360px] xl:w-[380px] space-y-4 lg:sticky lg:top-24">
              <Card className="p-6">
                ...
                <p className="mt-3 text-sm text-white/75 leading-relaxed">
                  ...
                  architecture, consolidated fragmented assets, navigated
                  platform constraints, and implemented a repeatable system for
                  visibility, rights protection, and income generation - while
                  intentionally avoiding sensitive commercial details.
                </p>
              ...
              {/* Listen / Watch (links stay normal anchors) */}
              <Card className="p-6">
                <div className="text-sm font-medium">Listen / Watch</div>
                <p className="mt-2 text-sm text-white/75">
                ...
                <div className="mt-4 grid grid-cols-1 gap-2">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <img
                        src="/case-studies/platforms/youtube.svg"
                        alt="YouTube"
                        className="h-5 w-5"
                      />
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <img
                        src="/case-studies/platforms/spotify.svg"
                        alt="Spotify"
                        className="h-5 w-5"
                      />
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <img
                        src="/case-studies/platforms/apple-music.svg"
                        alt="Apple Music"
                        className="h-5 w-5"
                      />
              ...
              <Card className="p-6">
                ...
                <ul className="mt-3 space-y-2 text-sm text-white/75">
                  ...
                  <li className="flex gap-2">
                    <Sparkles className="h-4 w-4 mt-0.5 text-[#C9A24D]" />
              ...
              {/* Disclaimer placed in sidebar (bottom-right vibe) */}
              <Card className="p-6">
                <div className="text-sm font-medium">Disclaimer & Rights</div>
                <p className="mt-3 text-sm text-white/75 leading-relaxed">
